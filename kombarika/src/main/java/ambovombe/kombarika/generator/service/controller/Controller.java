...
public class Controller{
    ...
    public String update(String table, HashMap<String, String> cols, HashMap<String, String> foreigns) throws Exception{
        String body = "";
        String args = "";
        String foreign = "";
    ...
    public String getCrudMethods(String table) throws Exception {
        ...
        String update = update(table, columns, foreignKeys);
