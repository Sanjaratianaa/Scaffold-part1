...
//////// DELETE
  ...
  return (
	...
	<div className="mb-3"> 
	 	...
	 	<input className="form-control" type="text" name="teethName" />
	</div>
	<div className="mb-3"> 
	...
	<div className="mb-3"> 
	 	<label className="form-label">Numero</label> 
	 	<input className="form-control" type="number" name="numero" onChange={handleInputNumeroChange} value={selectedItem ? selectedItem.numero:''} />
	</div>
	<div className="mb-3"> 
	 	<label className="form-label">Teeth Name</label> 
	 	<input className="form-control" type="text" name="teethName" onChange={handleInputTeethNameChange} value={selectedItem ? selectedItem.teethName:''} />
	</div>
	<div className="mb-3"> 
