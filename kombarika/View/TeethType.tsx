...
function teethType(){
  ...
  const handleSelectItem = (itemKey) => {
    handleShow2();
    const itemDetails = teethType.find(item => item.teethType === itemKey);
  ...
  const [currentPage, setCurrentPage] = useState(1);
	...
	const [teethType, setTeeth_type] = useState([]);
...
//////// DELETE
  const handleDeleteClick = async (item) => {
	...
	const handleInputTeethTypeChange = (event) => {
		setSelectedItem({ ...selectedItem, teethType: event.target.value });
	};
          ...
          <div className="row justify-content-end">
              <div className="col" >   
                  ...
                  <Modal show={show} onHide={handleClose}>
                      ...
                      <Modal.Title>Add teethType</Modal.Title>
                      </Modal.Header>
                      <Modal.Body>
	 	...
	 	<input className="form-control" type="text" name="name" />
          ...
          <div className="table-responsive">
			...
			<th> Name </th>
                  ...
                  <tbody id="table-body">
                      {teethType.map((item) => (
                              <tr key={item.teethType}>
		<td>{item.teethType}</td>
		<td>{item.name}</td>
              ...
              <Modal show={show2} onHide={handleClose2}>
                  <Modal.Header closeButton>
                      <Modal.Title>Update teethType</Modal.Title>
                  </Modal.Header>
                  <Modal.Body>    
                      <form action="" method="" id="update" onSubmit={handleUpdateSubmit}>
	<div className="mb-3"> 
	 	<label className="form-label"></label> 
	 	<input className="form-control" type="hidden" name="teethType" onChange={handleInputTeethTypeChange} value={selectedItem ? selectedItem.teethType:''} />
	</div>
	<div className="mb-3"> 
	 	<label className="form-label">Name</label> 
